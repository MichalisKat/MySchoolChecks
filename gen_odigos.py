...
def build():
    ...
    story += [
        ...
        _ftable([
            ...
            ('Αποτελέσματα',    'Αρχεία Excel στον φάκελο Έγγραφα → MySchoolChecksPlus'),
    ...
    story += [
        ...
        Paragraph('<b>Πού αποθηκεύονται:</b> Έγγραφα → MySchoolChecksPlus → downloads → YYYYMMDD', S['body']),
        PageBreak(),
    ]
    ...
    story += [
        ...
        _ftable([
            ...
            ('Αποτελέσματα', 'Αρχεία Excel στο φάκελο Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD'),
        ]),
        _sp(0.3),
    ...
    story += [
        ...
        Paragraph('Όλα τα αρχεία αποθηκεύονται στον φάκελο <b>Έγγραφα → MySchoolChecksPlus</b>:', S['body']),
        _ftable([
            ('Αποτελέσματα\nελέγχων',
             'Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD → [όνομα ελέγχου]'),
            ('Εκπ/κοί ανά\nειδικότητα',
             'Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD → Εκπαιδευτικοί_{ειδικ}_{ημερ}.xlsx'),
            ('Σχολικές\nΜονάδες',
             'Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD → ΣχολικέςΜονάδες_{δήμος}_{ημερ}.xlsx'),
            ('Στατιστικά\nαρχεία',
             'Έγγραφα → MySchoolChecksPlus → downloads → YYYYMMDD'),
        ]),
        _sp(0.3),
        Paragraph(
            'Το YYYYMMDD είναι η ημερομηνία (π.χ. 20260426 = 26 Απριλίου 2026). '
            'Τα αρχεία κάθε μέρας είναι σε ξεχωριστό φάκελο.', S['body']),
        _tip('Γρήγορη πρόσβαση: Win+R → %USERPROFILE%\\Documents\\MySchoolChecksPlus → Enter'),
        PageBreak(),
    ]
    ...
    story += [
        ...
        _ftable([
            ...
            ('Δεν βρίσκω\nτα αρχεία',
             'Έγγραφα → MySchoolChecksPlus (ή Win+R → %USERPROFILE%\\Documents\\MySchoolChecksPlus)'),
            ('Αδυνατεί η λήψη\nΤοποθετήσεων',
