...
PRE_SEND_WARNING = (
    'Πριν αποσταλούν emails στα σχολεία, είναι σημαντικό να γίνει χειροκίνητος '
    'έλεγχος των αποτελεσμάτων.\n\n'
    'Ενδέχεται να εμφανίζονται false περιπτώσεις, διότι το 4.21 (τοπικό και '
    'πανελλαδικό) δεν περιλαμβάνει τις άδειες που καταχωρεί το helpdesk — '
    'αυτές εμφανίζονται με κωδικό φορέα ITYE και δεν συμπεριλαμβάνονται στην '
    'εξαγωγή.'
)
