...
| **Έκδοση** | v0.9.8 beta — Απρίλιος 2026 |
...
|---|---|
| **Σύνδεση** | 7ψήφιος κωδικός & password MySchool + κωδικός email *(προαιρετικό — μόνο για αποστολή)* + επιλογή browser (Chrome/Firefox) |
...
**Πού αποθηκεύονται:** `Έγγραφα → MySchoolChecksPlus → downloads → YYYYMMDD`
...
Όλα τα αρχεία αποθηκεύονται στον φάκελο **Έγγραφα → MySchoolChecksPlus**:

| | |
|---|---|
| **Αποτελέσματα ελέγχων** | `Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD` |
| **Εκπ/κοί ανά Ειδικότητα** | `Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD` |
| **Σχολικές Μονάδες** | `Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD` |
| **Στατιστικά αρχεία** | `Έγγραφα → MySchoolChecksPlus → downloads → YYYYMMDD` |

Γρήγορη πρόσβαση: **Win+R** → `%USERPROFILE%\Documents\MySchoolChecksPlus` → Enter
...
- Αποτελέσματα ταξινομημένα αλφαβητικά στον φάκελο `Έγγραφα → MySchoolChecksPlus → results_YYYYMMDD`
...
| Δεν βρίσκω τα αρχεία | Έγγραφα → MySchoolChecksPlus (ή Win+R → `%USERPROFILE%\Documents\MySchoolChecksPlus`) |
...
![Οθόνη έναρξης](MySchoolChecksPlus/screenshots/1.png)

**Κύριο παράθυρο**

![Κύριο παράθυρο](MySchoolChecksPlus/screenshots/2.png)

**Ρυθμίσεις — Σύνδεση**

![Ρυθμίσεις Σύνδεση](MySchoolChecksPlus/screenshots/3.png)

**Ρυθμίσεις — Email**

![Ρυθμίσεις Email](MySchoolChecksPlus/screenshots/4.png)

**Ρυθμίσεις — Αρχεία**

![Ρυθμίσεις Αρχεία](MySchoolChecksPlus/screenshots/5.png)

**Λήψη Δεδομένων — Ολοκλήρωση**

![Λήψη Δεδομένων](MySchoolChecksPlus/screenshots/7.png)

**Παραμετροποίηση ελέγχου**

![Παραμετροποίηση ελέγχου](MySchoolChecksPlus/screenshots/8.png)

**Επιλογές αποστολής email**

![Επιλογές αποστολής](MySchoolChecksPlus/screenshots/9.png)

**Αποτελέσματα ελέγχου**

![Αποτελέσματα ελέγχου](MySchoolChecksPlus/screenshots/10.png)

**Αρχείο Excel αποτελεσμάτων**

![Excel αποτελεσμάτων](MySchoolChecksPlus/screenshots/11.png)

**Αποτελέσματα χωρίς θέματα**

![Καθαρά αποτελέσματα](MySchoolChecksPlus/screenshots/12.png)

**Test mode**

![Test mode emails](MySchoolChecksPlus/screenshots/13.png)
