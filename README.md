...
> Αν δεν έχεις κατεβάσει τα αρχεία, το πρόγραμμα σε ενημερώνει ποια χρειάζονται και πώς να τα κατεβάσεις.
...
*Αφιερώνεται στον συνάδελφο Χρήστο Νιαβή, η συνεργασία με τον οποίο αποτελεί πηγή έμπνευσης, δημιουργικότητας και ουσιαστικής προσέγγισης στις προκλήσεις.*
