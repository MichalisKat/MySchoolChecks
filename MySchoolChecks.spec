...
datas = [
    ...
    ('MySchoolChecks\\work_hours_details.py', '.'),
    ('MySchoolChecks\\work_hours_details_template.xlsx', '.'),
    ('MySchoolChecks\\placements.py', '.'),
    ('MySchoolChecks\\placements_template.xlsx', '.'),
    ('MySchoolChecks\\termination_template.xlsx', '.'),
    ('MySchoolChecks\\functionality_template.xlsx', '.'),
